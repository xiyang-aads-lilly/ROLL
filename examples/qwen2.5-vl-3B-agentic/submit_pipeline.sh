...
WORKER_COUNT=1
CONFIG_FILE="agentic_val_sokoban.yaml"
# 替换为mos uri
NEBULA_MODEL=""
ENTRY_FILE="examples/start_agentic_vl_pipeline.py"
...
mdl_args="--queue=${QUEUE} \
        ...
        --job_name=${JOB_NAME} \
        --algo_name=pytorch251 \
        --requirements_file_name=nebula_patch/requirements/requirements_torch251_vllm.txt \
        --oss_appendable=true \
